...
<br>		
		    ...
		    <ul>
			  <li>
			    <table width="1333" height="60" border="1">
			      <tr >
                    <th width="29" height="24" scope="col">No.</th>
			        <th width="83" scope="col">รหัสใบสั่งซื้อ</th> 
                    <th width="65" scope="col">รหัสสินค้า</th>
                    <th width="115" scope="col">ชื่อสินค้า</th>
                    <th width="83" scope="col">รหัสพนักงาน</th>
                    <th width="159" scope="col">ชื่อพนักงาน</th>
                    <th width="67" scope="col">รหัสบริษัท</th>
			        <th width="186" scope="col">บริษัท</th>
			        <th width="107" scope="col">สถานะการสั่งซื้อ</th>
                    <th width="106" scope="col">วันที่สั่งซื้อสินค้า</th>
			        <th width="84" scope="col">วันที่รับสินค้า</th>
			        <th width="84" scope="col">จำนวนสั่งซื้อ</th>
			        <th width="83" scope="col">ยอดรวมราคา</th>
		          </tr>
		          <tr>
			        <td>&nbsp;</td>
                    <td>&nbsp;</td>
