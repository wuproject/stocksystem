...
<body>
	...
	<div class="agileits-main">
        ...
        <div class="clear"></div>
			  ...
			  <li>
			    <table width="987" height="60" border="1">
			      <tr>
                    <th width="27" scope="col">No.</th>
			        <th width="103" scope="col">รหัสใบคืนสินค้า</th> 
                    <th width="71" scope="col">รหัสสินค้า</th>
			        <th width="131" scope="col">ชื่อสินค้า</th>
			        <th width="93" scope="col">วันที่คืนสินค้า</th>
                    <th width="84" scope="col">วันที่รับสินค้า</th>
			        <th width="53" scope="col">จำนวน</th>
                    <th width="75" scope="col">ราคา</th>
			        <th width="87" scope="col">ยอดรวมราคา</th> 
                    <th width="67" scope="col">รหัสบริษัท</th>
			        <th width="112" scope="col">ชื่อบริษัท</th>
