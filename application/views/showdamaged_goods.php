...
<body>
	...
	<a href="<?php echo site_url("showorder")?>"></a>
	      ...
	      <ul>
			  <li>
			    <table width="691" border="1">
			      <tr>
                    <th width="41" scope="col">No.</th>
			        <th width="100" scope="col">รหัสสินค้าชำรุด</th> 
                    <th width="65" scope="col">รหัสสินค้า</th>
			        <th width="145" scope="col">ชื่อสินค้า</th>			        
			        <th width="57" scope="col">จำนวน</th>
                    <th width="65" scope="col">ราคา</th>
			        <th width="87" scope="col">ยอดรวมราคา</th>		        
			        <th width="79" scope="col">รหัสพนักงาน</th>		        
		          </tr>
		          <tr>
			        <td>&nbsp;</td>
                    <td>&nbsp;</td>
