...
<br>		
		    ...
		    <ul>
			  <li>
			    <table width="791" height="60" border="1">
			      <tr>
                    <th width="25" scope="col">No.</th>
			        <th width="106" scope="col">รหัสใบเบิกสินค้า</th> 
                    <th width="65" scope="col">รหัสสินค้า</th>
			        <th width="132" scope="col">ชื่อสินค้า</th>
			        <th width="91" scope="col">วันที่เบิกสินค้า</th>
			        <th width="83" scope="col">จำนวนสินค้า</th>
			        <th width="83" scope="col">รหัสพนักงาน</th>
			        <th width="154" scope="col">ชื่อพนักงาน</th>
		          </tr>
		          <tr>
			        <td>&nbsp;</td>
                    <td>&nbsp;</td>
